...
- Name: ui\critical-journeys.ui.spec.js >> [AGENT] Workflow RDV — actions sur les rendez-vous >> ✅ [IHM-016] Agent marque "Présent" → RDV confirme → en_cours, boutons changent
- Location: tests\e2e\ui\critical-journeys.ui.spec.js:823:3
