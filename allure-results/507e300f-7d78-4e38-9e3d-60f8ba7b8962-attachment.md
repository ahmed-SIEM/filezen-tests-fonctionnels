...
- Name: ui\ticket.ui.spec.js >> IHM — Ticket / File attente — acces et protection >> [UI-TKT-002] Page mes-tickets non connecte → redirection login
- Location: tests\e2e\ui\ticket.ui.spec.js:27:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/citoyen/mes-tickets
Call log:
  - navigating to "http://localhost:5174/citoyen/mes-tickets", waiting until "load"
