...
- Name: ui\ticket.ui.spec.js >> IHM — Navigation et experience utilisateur >> [UI-TKT-010] Page 404 geree proprement (route inexistante)
- Location: tests\e2e\ui\ticket.ui.spec.js:113:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/cette-page-nexiste-vraiment-pas-12345
Call log:
  - navigating to "http://localhost:5174/cette-page-nexiste-vraiment-pas-12345", waiting until "load"
