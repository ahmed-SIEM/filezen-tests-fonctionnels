...
- Name: ui\critical-journeys.ui.spec.js >> [ANTI-SPAM] Limites métier tickets — confirmées backend >> ✅ [IHM-007] Ticket actif existant → 2ème ticket bloqué "déjà un ticket actif"
- Location: tests\e2e\ui\critical-journeys.ui.spec.js:473:3
...
```ts
  ...
  19  | 
  20  | const FRONT = process.env.FRONTEND_URL || 'http://localhost:5173';
