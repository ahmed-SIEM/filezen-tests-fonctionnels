...
- Name: ui\ticket.ui.spec.js >> IHM — Ticket / File attente — acces et protection >> [UI-TKT-003] Dashboard agent non connecte → redirection login
- Location: tests\e2e\ui\ticket.ui.spec.js:34:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/agent/dashboard
Call log:
  - navigating to "http://localhost:5174/agent/dashboard", waiting until "load"
