...
- Name: ui\critical-journeys.ui.spec.js >> [AUTH] Sécurité session >> ✅ [IHM-020] Token expiré (401) → déconnexion automatique + redirect /login
- Location: tests\e2e\ui\critical-journeys.ui.spec.js:1057:3
