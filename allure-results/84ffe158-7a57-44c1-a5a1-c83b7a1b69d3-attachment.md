...
- Name: ui\dashboard.ui.spec.js >> IHM — Inscription etablissement >> [UI-DASH-012] Formulaire inscription etab contient champs nom et email
- Location: tests\e2e\ui\dashboard.ui.spec.js:109:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/signup/etablissement
Call log:
  - navigating to "http://localhost:5174/signup/etablissement", waiting until "load"
