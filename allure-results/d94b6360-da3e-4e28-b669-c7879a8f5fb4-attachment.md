...
- Name: ui\dashboard.ui.spec.js >> IHM — Dashboard Citoyen (acces non autorise) >> [UI-DASH-009] /citoyen/mes-rdv non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:83:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/citoyen/mes-rdv
Call log:
