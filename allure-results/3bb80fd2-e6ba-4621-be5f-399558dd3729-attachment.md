...
- Name: ui\dashboard.ui.spec.js >> IHM — Dashboard Admin Etablissement (acces non autorise) >> [UI-DASH-003] /admin/agents non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:33:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/agents
Call log:
  - navigating to "http://localhost:5174/admin/agents", waiting until "load"
