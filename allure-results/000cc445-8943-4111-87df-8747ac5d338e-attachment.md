...
- Name: ui\dashboard.ui.spec.js >> IHM — Dashboard Super Admin (acces non autorise) >> [UI-DASH-007] /superadmin/validate non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:65:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/superadmin/validate
Call log:
  - navigating to "http://localhost:5174/superadmin/validate", waiting until "load"
