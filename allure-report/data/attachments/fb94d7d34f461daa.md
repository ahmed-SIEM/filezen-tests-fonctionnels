...
- Name: ui\dashboard.ui.spec.js >> IHM — Dashboard Citoyen (acces non autorise) >> [UI-DASH-010] /citoyen/notifications non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:90:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/citoyen/notifications
Call log:
  - navigating to "http://localhost:5174/citoyen/notifications", waiting until "load"
