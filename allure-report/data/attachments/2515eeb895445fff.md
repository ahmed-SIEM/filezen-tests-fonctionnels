...
- Name: ui\dashboard.ui.spec.js >> IHM — Dashboard Admin Etablissement (acces non autorise) >> [UI-DASH-004] /admin/stats non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:40:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/stats
Call log:
  - navigating to "http://localhost:5174/admin/stats", waiting until "load"
