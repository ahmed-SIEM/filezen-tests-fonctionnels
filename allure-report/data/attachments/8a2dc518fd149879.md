...
- Name: ui\dashboard.ui.spec.js >> IHM — SuperAdmin Detail Etablissement >> [UI-DASH-019] Route superadmin establishments liste non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:183:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/superadmin/establishments
Call log:
  - navigating to "http://localhost:5174/superadmin/establishments", waiting until "load"
