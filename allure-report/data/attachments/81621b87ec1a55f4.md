...
- Name: ui\dashboard.ui.spec.js >> IHM — Dashboard Admin Etablissement (acces non autorise) >> [UI-DASH-002] /admin/services non connecte → redirection
- Location: tests\e2e\ui\dashboard.ui.spec.js:26:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/services
Call log:
  - navigating to "http://localhost:5174/admin/services", waiting until "load"
