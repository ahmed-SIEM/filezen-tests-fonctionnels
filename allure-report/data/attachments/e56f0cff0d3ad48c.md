...
- Name: ui\etablissement.ui.spec.js >> IHM — File d attente (vue citoyen) >> [UI-ETAB-009] Page file d attente accessible (publique ou protegee)
- Location: tests\e2e\ui\etablissement.ui.spec.js:119:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/file-attente
Call log:
  - navigating to "http://localhost:5174/file-attente", waiting until "load"
