...
- Name: ui\ticket.ui.spec.js >> IHM — Suivi ticket (affichage public) >> [UI-TKT-006] Page de suivi accessible sans connexion (QR code use case)
- Location: tests\e2e\ui\ticket.ui.spec.js:60:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/citoyen/track-ticket/507f1f77bcf86cd799439011
Call log:
  - navigating to "http://localhost:5174/citoyen/track-ticket/507f1f77bcf86cd799439011", waiting until "load"
