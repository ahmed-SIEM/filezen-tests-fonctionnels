...
- Name: ui\ticket.ui.spec.js >> IHM — Ticket / File attente — acces et protection >> [UI-TKT-004] Interface agent stats non connecte → redirection
- Location: tests\e2e\ui\ticket.ui.spec.js:41:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/agent/stats
Call log:
  - navigating to "http://localhost:5174/agent/stats", waiting until "load"
