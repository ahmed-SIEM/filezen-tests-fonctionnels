...
- Name: ui\ticket.ui.spec.js >> IHM — Suivi ticket (affichage public) >> [UI-TKT-005] Page suivi ticket avec ID inexistant gere proprement
- Location: tests\e2e\ui\ticket.ui.spec.js:52:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/ticket/507f1f77bcf86cd799439011
Call log:
  - navigating to "http://localhost:5174/ticket/507f1f77bcf86cd799439011", waiting until "load"
