...
- Name: ui\ticket.ui.spec.js >> IHM — Affichage file d attente (ecran public) >> [UI-TKT-007] Page affichage file publique accessible
- Location: tests\e2e\ui\ticket.ui.spec.js:72:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/display
Call log:
  - navigating to "http://localhost:5174/display", waiting until "load"
